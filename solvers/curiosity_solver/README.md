...
An implementation of curiosity-driven active inference for solving ARC-AGI tasks, based on the theoretical frameworks in `docs/theory/curiosity/`.
...
Based on frameworks in `docs/theory/curiosity/`:
